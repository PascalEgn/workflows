...
class TestUnitOupReharvest:
    ...
    def test_collect_records_invalid_combination_file_keys_and_dois(self):
        ...
        with pytest.raises(ValueError, match="file_keys and dois"):
            function_to_unit_test(
                ...
                params={
                    "file_keys": [
                        "extracted/SCOAP-Article-Submission/January/30-01-2026/ptep_iss_2026_1.xml/ptac108.xml"
                    ],
    ...
    def test_collect_records_date_range_dedup_keeps_newest(self):
        ...
        payload_by_key = {
            "extracted/SCOAP-Article-Submission/August/15-08-2025/ptep_iss_2025_8_part1.xml/ptac108.xml": _xml_with_doi(
                "10.1093/ptep/ptac108"
            ),
            "extracted/SCOAP-Article-Submission/January/30-01-2026/ptep_iss_2025_12_part7.xml/ptac108.xml": _xml_with_doi(
                "10.1093/ptep/ptac108"
            ),
            "extracted/SCOAP-Article-Submission/December/19-12-2025/ptep_iss_2025_12_part5.xml/ptac113.xml": _xml_with_doi(
        ...
        assert len(result) == 2
        assert (
            "extracted/SCOAP-Article-Submission/January/30-01-2026/ptep_iss_2025_12_part7.xml/ptac108.xml"
            in result
        )
        assert (
            "extracted/SCOAP-Article-Submission/December/19-12-2025/ptep_iss_2025_12_part5.xml/ptac113.xml"
            in result
        )
    ...
    def test_collect_records_file_keys_limit_exceeded_raises(self):
        ...
        payload_by_key = {
            "extracted/SCOAP-Article-Submission/December/19-12-2025/ptep_iss_2025_12_part5.xml/ptac108.xml": _xml_with_doi(
                "10.1093/ptep/ptac108"
            ),
            "extracted/SCOAP-Article-Submission/December/19-12-2025/ptep_iss_2025_12_part5.xml/ptac113.xml": _xml_with_doi(
                "10.1093/ptep/ptac113"
        ...
        with pytest.raises(ValueError, match="above limit"):
            function_to_unit_test(
                ...
                params={
                    "file_keys": [
                        "extracted/SCOAP-Article-Submission/December/19-12-2025/ptep_iss_2025_12_part5.xml/ptac108.xml",
                        "extracted/SCOAP-Article-Submission/December/19-12-2025/ptep_iss_2025_12_part5.xml/ptac113.xml",
                    ],
                    "limit": 1,
                },
    ...
    def test_collect_records_glob_patterns(self):
        ...
        payload_by_key = {
            ...
            "extracted/SCOAP-Article-Submission/January/30-01-2026/ptep_iss_2025_12_part7.xml/ptac120.xml": _xml_with_doi(
                "10.1093/ptep/ptac120"
            ),
        }
        mock_repo = self._build_repo(payload_by_key)

        # '*' should match all three SCOAP keys
        ...
        # Pattern scoped to August only
        result_august = function_to_unit_test(
            repo=mock_repo,
            params={"file_keys": ["SCOAP-Article-Submission/August/*"]},
        )
        assert result_august == [
            "extracted/SCOAP-Article-Submission/August/15-08-2025/ptep_iss_2025_8_part1.xml/ptac108.xml"
        ]

        # Mix of exact key and glob – deduplication must keep only one copy
        result_mixed = function_to_unit_test(
            repo=mock_repo,
            params={
                "file_keys": [
                    "extracted/SCOAP-Article-Submission/August/15-08-2025/ptep_iss_2025_8_part1.xml/ptac108.xml",
                    "SCOAP-Article-Submission/August/*",
                ]
            },
        )
        assert result_mixed == [
    ...
    def test_prepare_trigger_conf_dry_run_and_normal(self):
        ...
        file_key = "extracted/SCOAP-Article-Submission/August/15-08-2025/ptep_iss_2025_8_part1.xml/ptac108.xml"
