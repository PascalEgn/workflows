...
class TestUnitApsReharvest:
    ...
    def test_dag_structure(self):
        assert "aps_reharvest_trigger_file_processing" in self.dag.task_ids
        task = self.dag.get_task("aps_reharvest_trigger_file_processing")
    ...
    def test_collect_articles_invalid_combination_file_keys_and_dois(self):
        task = self.dag.get_task("collect_articles")
    ...
    def test_collect_articles_date_range_dedup_keeps_newest(self):
        task = self.dag.get_task("collect_articles")
        function_to_unit_test = task.python_callable
    ...
    def test_collect_articles_limit_exceeded_raises(self):
        task = self.dag.get_task("collect_articles")
        function_to_unit_test = task.python_callable
    ...
    def test_collect_articles_dois_without_dates_defaults_last_year(self):
        task = self.dag.get_task("collect_articles")
        function_to_unit_test = task.python_callable
    ...
    def test_collect_articles_dois_range_too_large_raises(self):
        task = self.dag.get_task("collect_articles")
        function_to_unit_test = task.python_callable
